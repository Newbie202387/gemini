        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto leading-relaxed">
              ...
              data practices and full compliance with the General Data
          ...
          >
            ...
            <p className="text-gray-300 text-center mb-6">
              Need to access, update, or delete your data? Contact us directly
            ...
            <div className="space-y-8">
              ...
              >
                ...
                <p className="text-sm text-gray-300 mb-4">
                  ...
                  cookies for analytics. You can manage preferences anytime.
                </p>
                <Button
                  variant="outline"
                  size="sm"

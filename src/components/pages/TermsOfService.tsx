            ...
            <div className="bg-gray-800 rounded-xl p-8 border border-gray-700">
              ...
              <section id="introduction" className="mb-12">
                ...
                <p className="text-gray-300 mb-4">
                  ...
                  of Service (&quot;Terms&quot;, &quot;Terms of Service&quot;)
                  govern your use of our website located at geminipixelcraft.com
              ...
              <section id="definitions" className="mb-12">
                ...
                <ul className="text-gray-300 space-y-2">
                  <li>
                    ...
                    provided by Gemini Pixel Craft
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Content:</strong> Refers to text, images, code, and
                    other materials
                  </li>
                  <li>
                    <strong>Account:</strong> Refers to your personalized access
                    to our Service
                  </li>
                </ul>
              </section>
              ...
              <section id="payments" className="mb-12">
                ...
                <p className="text-gray-300 mb-4">
                  <strong>Payment Terms:</strong> 50% deposit required to begin
                  work, with remaining balance due upon project completion
              ...
              <section id="governing-law" className="mb-12">
                ...
                <p className="text-gray-300 mb-4">
                  ...
                  the laws of Florida, United States, without regard to its

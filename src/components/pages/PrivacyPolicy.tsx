              ...
              <div className="bg-gray-800 rounded-xl p-8 border border-gray-700">
                ...
                <section id="introduction" className="mb-12">
                  ...
                  <p className="text-gray-300">
                    ...
                    through the Website. We have adopted this privacy policy to
                    explain what information may be collected on our Website,
                    how we use this information, and under what circumstances we
                ...
                <section id="data-collection" className="mb-12">
                  ...
                  <div className="bg-cyan-400/10 border border-cyan-400/20 rounded-lg p-4">
                    ...
                    <p className="text-gray-300 text-sm">
                      ...
                      type, operating system, referring URLs, device
                      information, and pages visited. This information helps us
                      understand how visitors use our site and improve their
                      experience.
                    </p>
                  </div>
                </section>
                ...
                <section id="data-protection" className="mb-12">
                  ...
                  <p className="text-gray-300">
                    ...
                    secure. We cannot guarantee absolute security but we strive
                ...
                <section id="your-rights" className="mb-12">
                  ...
                  <div className="bg-fuchsia-400/10 border border-fuchsia-400/20 rounded-lg p-4">
                    ...
                    <p className="text-gray-300 text-sm">
                      ...
                      request within 30 days and may need to verify your
                ...
                <section id="cookies" className="mb-12">
                  ...
                  <p className="text-gray-300 mb-4">
                    ...
                    some features of our site may not function properly without
                    them.
                  </p>
                </section>

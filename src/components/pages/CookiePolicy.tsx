              ...
              <div className="bg-gray-800 rounded-xl p-8 border border-gray-700">
                ...
                <section id="introduction" className="mb-12">
                  ...
                  <p className="text-gray-300 mb-4">
                    ...
                    visit our website at geminipixelcraft.com. It explains what
                ...
                <section id="what-are-cookies" className="mb-12">
                  ...
                  <p className="text-gray-300">
                    ...
                    your device until you delete them or they expire, while
                ...
                <section id="cookie-purpose" className="mb-12">
                  ...
                  <ul className="text-gray-300 space-y-2 mb-4">
                    <li className="flex items-start">
                      ...
                      <span>
                        <strong>Essential Operation:</strong> Cookies required
                        for the basic functions of our website
                      </span>
                    </li>
                    <li className="flex items-start">
                      <div className="w-1.5 h-1.5 bg-cyan-400 rounded-full mt-2 mr-3 flex-shrink-0"></div>
                      <span>
                        <strong>Performance Analytics:</strong> Understanding
                ...
                <section id="third-party-cookies" className="mb-12">
                  ...
                  <p className="text-gray-300">
                    ...
                    and cookie policies. We recommend reviewing their policies
                  ...
                  <div className="grid md:grid-cols-2 gap-6 mb-4">
                    <div className="bg-gray-700/30 rounded-lg p-4">
                      ...
                      <p className="text-gray-300 text-sm">
                        ...
                        settings preferences. You can usually find these
                        settings in the &quot;Options&quot; or
                    ...
                    <div className="bg-gray-700/30 rounded-lg p-4">
                      ...
                      <p className="text-gray-300 text-sm">
                        Use the cookie settings tool on our website to manage
                        your preferences for analytics, marketing, and
                ...
                <section id="updates" className="mb-12">
                  ...
                  <p className="text-gray-300 mb-4">
                    ...
                    operations. When we do, we will revise the &quot;last
